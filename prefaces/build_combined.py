...
CODE = os.environ.get('DICT', 'krm')
# (suffix, outfile, doc title, page-word, src-word) ; 'src' is the source-language base.
# KRM front matter is in English (two Sanskrit title/portrait pages kept verbatim),
# so there is no separate '.en' edition — the source base IS the English text.
LANGS = {
  'src': ('.md',    f'{CODE}pref_all.en.md', 'Front matter — complete (source: English, with Sanskrit pages verbatim)', 'Page',     'Source'),
